...
class CustomPDF(FPDF):
    def header(self):
        self.set_xy(158, 2)
        self.image('/Users/jingwang/Desktop/jibpool_logo.png', h=30)
    ...
    def footer(self):
        self.set_xy(0, -50)
        self.image('/Users/jingwang/Desktop/jibpool_footer.png', h=19)
...
def generate_pdf(quote_info, file_name):
    ...
    pdf.set_xy(10, 94)
    pdf.cell(190, 6, "Supply and install of TAKIRON exterior grade water proof flooring with slip-resistance", ln=True, align='L')

    pdf.set_xy(5, 104)
    pdf.set_font("Arial", style='BU', size=12)
    pdf.cell(20, 7, "Item", align='C')
    pdf.cell(80, 7, "Description", align='L')
    pdf.cell(20, 7, "Product No.", align='C')
    pdf.cell(25, 7, "Unit Price HKD", align='R')
    ...
    for i, line in enumerate(quote_info.split('\n'), start = 1):
        ...
        pdf.set_x(5)
        pdf.cell(20, 10, str(i), 0, 0, 'C')
        pdf.cell(80, 10, description, 0, 0, 'L')
        pdf.cell(20, 10, product_service, 0, 0, 'C')
...
# Example call to generate the PDF with custom header, footer, and table
quote_info = """Description: kitchen wall tiling, Product No.: Whirlpool SCEBM0401MT, QTY.: 27"""
generate_pdf(quote_info, "quotation_with_custom_header_footer.pdf")